...
void UObjectDataSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	BaseTable = Cast<UDataTable>(StaticLoadObject(UDataTable::StaticClass(), nullptr, TEXT("/Game/DataTables/ObjectStatDataTable_ObjectBase.ObjectStatDataTable_ObjectBase")));
	RewardTable = Cast<UDataTable>(StaticLoadObject(UDataTable::StaticClass(), nullptr, TEXT("/Game/DataTables/ObjectStatDataTable_ObjectReward.ObjectStatDataTable_ObjectReward")));
	MechanicsTable = Cast<UDataTable>(StaticLoadObject(UDataTable::StaticClass(), nullptr, TEXT("/Game/DataTables/ObjectStatDataTable_ObjectMechanics.ObjectStatDataTable_ObjectMechanics")));
